...
public class SpecialEvents : Singleton<SpecialEvents>
{
    ...
    private IEnumerator TriggerEvent2Coroutine()
    {
        ...
        GameManager.Instance.UIManager.OpenPanel<FadeInOutWindow>(UIType.FadeInOutWindow); //開啟淡出淡入
        GameManager.Instance.UIManager.GetPanel<FadeInOutWindow>(UIType.FadeInOutWindow).ChangeImage(); //更改圖片
        GameManager.Instance.UIManager.GetPanel<FadeInOutWindow>(UIType.FadeInOutWindow).FadeIn(1, 0.05f); //啟動淡入，速度為0.05f
        ...
        GameManager.Instance.UIManager.GetPanel<FadeInOutWindow>(UIType.FadeInOutWindow).ChangeImageToNull();
